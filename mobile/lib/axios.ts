...
const API_URL = "http://localhost:3000/api"; // <--- http://app.write_despite.network/api

// --- this is the same thing we did with useEffect setup but it is optimized version ---
